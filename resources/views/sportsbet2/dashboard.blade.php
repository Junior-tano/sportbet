...
<head>
  ...
  <title>Dashboard - SportsBet Simulator</title>
  ...
  <nav class="bg-[#1e293b] shadow-lg border-b border-[#334155]">
    <div class="container mx-auto px-4">
      <div class="flex justify-between items-center h-16">
        <div class="flex items-center">
          <a href="index.html" class="text-xl font-bold text-[#10b981] flex items-center gap-2">
        ...
        <div class="hidden md:flex items-center space-x-1">
          <a href="index.html" class="px-3 py-2 rounded-md hover:bg-[#334155] flex items-center gap-2">
            <i class="fas fa-home"></i>
            <span>Accueil</span>
          </a>
          <a href="matchs.html" class="px-3 py-2 rounded-md hover:bg-[#334155] flex items-center gap-2">
            <i class="fas fa-trophy"></i>
            <span>Matchs</span>
          </a>
          <a href="mes-paris.html" class="px-3 py-2 rounded-md hover:bg-[#334155] flex items-center gap-2">
            <i class="fas fa-history"></i>
            <span>Mes Paris</span>
          </a>
          <a href="dashboard.html" class="px-3 py-2 rounded-md bg-[#334155] flex items-center gap-2">
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-[#1e293b] border-t border-[#334155]">
      <div class="px-2 pt-2 pb-3 space-y-1">
        <a href="index.html" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-[#334155]">
          <i class="fas fa-home"></i>
          <span>Accueil</span>
        </a>
        <a href="matchs.html" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-[#334155]">
          <i class="fas fa-trophy"></i>
          <span>Matchs</span>
        </a>
        <a href="mes-paris.html" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-[#334155]">
          <i class="fas fa-history"></i>
          <span>Mes Paris</span>
        </a>
        <a href="dashboard.html" class="flex items-center gap-2 px-3 py-2 rounded-md bg-[#334155]">
          <i class="fas fa-chart-line"></i>
          <span>Dashboard</span>
        </a>
